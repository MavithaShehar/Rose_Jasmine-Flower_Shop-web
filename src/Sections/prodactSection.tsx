                        ...
                        >
                            <div className="flex flex-col items-center bg-amber-300">
                                ...
                                <div className="text-center space-y-2 bg-red-600">
                                    ...
                                    <span className="block text-lg font-semibold text-gray-900">${flower.price}</span>
                                </div>
                            </div>
                            ...
                            <div className="flex justify-around items-center mt-2 ">
                                <div className="flex items-center space-x-2 ">
                                    ...
                                    <button className="text-sm px-3 py-1 border border-green-400 rounded-2xl hover:bg-gray-200 active:bg-blue-300">-</button>
