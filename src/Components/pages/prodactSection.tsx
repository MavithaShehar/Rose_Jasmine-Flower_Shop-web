  ...
  return (
    <section className="">
      <div className="w-full pl-20 pr-20 ">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 bg mb-5 ">
          {flowers.map((flower) => {
                ...
                >
                  <div className="flex flex-col items-center ">
                    ...
                    <div
                      ...
                      className="w-full h-64 rounded-1xl bg-center bg-cover mb-4 mask-contain"
                    ></div>
